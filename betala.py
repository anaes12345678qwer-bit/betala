...
TOKEN = os.getenv('8950016545:AAH28MgnlJfv0fVHXGpZa5uAqffK-p4uH4M')
if not TOKEN:
    raise RuntimeError('BOT_TOKEN is not set in Render Environment Variables')
ADMIN_ID = 6846407080 # ايديك
YOUR_USERNAME = '@AMAL❤️‍🩹AMAL💔DZ😘24'  #  @ يوزرك مع
CHANNEL_USERNAME = '@BlackStarPrime'  # يوزر القناة الإجبارية


bot = telebot.TeleBot(TOKEN)
# Remove any old Telegram webhook before starting polling.
try:
